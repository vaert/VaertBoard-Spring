...
<body>
			...
			<c:otherwise>
				...
				<tr>
					...
					<td align="center"><c:out value="${board.writer}" /></td>
	 				<td align="center"><c:out value="${fn:substring(board.reg_Date, 0, 10)}" /></td>	
	...
	<p>
		<input type="button" value="목록" onclick="goUrl('<c:url value="/spring/board/boardList"/>');" />
		<input type="button" value="글쓰기" onclick="goUrl('<c:url value="/spring/board/boardWrite"/>');" />
	</p>
</body>
</html>